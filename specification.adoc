...
The expression is encoded in `data` in a way that only Python can decode. It is a https://en.wikipedia.org/wiki/Base64[Base64] encoding of a https://docs.python.org/3/library/pickle.html[Pickled] object.
