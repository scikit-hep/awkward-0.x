...
The expression is a list of <<Deserialization expressions,expressions>>.

===== `+{"tuple": [expressions...]}+`

The expression is a tuple of <<Deserialization expressions,expressions>>.

===== `+{"pairs": [[name, expression], ...]}+`

The expression is a list of name (string), <<Deserialization expressions,expression>> pairs.
