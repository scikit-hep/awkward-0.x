...
public:
    static py::array_t<std::int64_t> offsets2parents_int64(py::array_t<std::int64_t> offsets) {
    ...
    static py::array_t<std::int32_t> offsets2parents_int32(py::array_t<std::int32_t> offsets) {
        py::buffer_info offsets_info = offsets.request();
        if (offsets_info.size <= 0) {
            throw std::invalid_argument("offsets must have at least one element");
        }
    ...
    static py::array_t<std::int64_t> counts2offsets_int64(py::array_t<std::int64_t> counts) {
    ...
    static py::array_t<std::int32_t> counts2offsets_int32(py::array_t<std::int32_t> counts) {
        py::buffer_info counts_info = counts.request();
    ...
    static py::array_t<std::int64_t> startsstops2parents_int64(py::array_t<std::int64_t> starts, py::array_t<std::int64_t> stops) {
    ...
    static py::array_t<std::int32_t> startsstops2parents_int32(py::array_t<std::int32_t> starts, py::array_t<std::int32_t> stops) {
        py::buffer_info starts_info = starts.request();
    ...
    static py::tuple parents2startsstops_int64(py::array_t<std::int64_t> parents, size_t length) {
        py::buffer_info parents_info = parents.request();
        auto parents_ptr = (std::int64_t*)parents_info.ptr;
    ...
    static py::tuple parents2startsstops_int32(py::array_t<std::int32_t> parents, size_t length) {
        py::buffer_info parents_info = parents.request();
        auto parents_ptr = (std::int32_t*)parents_info.ptr;
    ...
    static py::tuple uniques2offsetsparents_int64(py::array_t<std::int64_t> uniques) {
    ...
    static py::tuple uniques2offsetsparents_int32(py::array_t<std::int32_t> uniques) {
        py::buffer_info uniques_info = uniques.request();
...
PYBIND11_MODULE(_jagged, m) {
    py::class_<JaggedArraySrc>(m, "JaggedArraySrc")
        .def(py::init<>())
        .def_static("offsets2parents_int64", &JaggedArraySrc::offsets2parents_int64)
        .def_static("offsets2parents_int32", &JaggedArraySrc::offsets2parents_int64)
        .def_static("counts2offsets_int64", &JaggedArraySrc::counts2offsets_int64)
        .def_static("counts2offsets_int32", &JaggedArraySrc::counts2offsets_int32)
        .def_static("startsstops2parents_int64", &JaggedArraySrc::startsstops2parents_int64)
        .def_static("startsstops2parents_int32", &JaggedArraySrc::startsstops2parents_int32)
        .def_static("parents2startsstops_int64", &JaggedArraySrc::parents2startsstops_int64)
        .def_static("parents2startsstops_int32", &JaggedArraySrc::parents2startsstops_int32)
        .def_static("uniques2offsetsparents_int64", &JaggedArraySrc::uniques2offsetsparents_int64)
        .def_static("uniques2offsetsparents_int32", &JaggedArraySrc::uniques2offsetsparents_int32);
}
