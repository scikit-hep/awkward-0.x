...
.. raw:: html
    ...
    <img src="https://latex.codecogs.com/svg.latex?m%3D%5Csqrt%7B(E_1%2BE_2)%5E2-(p_%7Bx1%7D%2Bp_%7Bx2%7D)%5E2-(p_%7By1%7D%2Bp_%7By2%7D)%5E2-(p_%7Bz1%7D%2Bp_%7Bz2%7D)%5E2%7D" title="m=\sqrt{(E_1+E_2)^2-(p_{x1}+p_{x2})^2-(p_{y1}+p_{y2})^2-(p_{z1}+p_{z2})^2}" />

.. role:: raw-html(raw)
    :format: html

you might first compute :raw-html:`<img src="https://latex.codecogs.com/svg.latex?%5Csqrt%7B(p_%7Bx1%7D%2Bp_%7Bx2%7D)%5E2%2B(p_%7By1%7D%2Bp_%7By2%7D)%5E2%7D" title="\sqrt{(p_{x1}+p_{x2})^2+(p_{y1}+p_{y2})^2}" />` for all data (which is a meaningful quantity: :raw-html:`<img src="https://latex.codecogs.com/svg.latex?p_T" title="p_T" />`), then compute :raw-html:`<img src="https://latex.codecogs.com/svg.latex?%5Csqrt%7B%7Bp_T%7D%5E2%2B(p_%7Bz1%7D%2Bp_%7Bz2%7D)%5E2%7D" title="\sqrt{{p_T}^2+(p_{z1}+p_{z2})^2}" />` for all data (another meaningful quantity: :raw-html:`<img src="https://latex.codecogs.com/svg.latex?%7Cp%7C" title="|p|" />`), then compute the whole expression as :raw-html:`<img src="https://latex.codecogs.com/svg.latex?%5Csqrt%7B(E_1%2BE_2)%5E2-%7Cp%7C%5E2%7D" title="\sqrt{(E_1+E_2)^2-|p|^2}" />`. Performing each step separately on all data lets you plot and cross-check distributions of partial computations, to discover surprises as early as possible.
