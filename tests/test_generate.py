...
class Test(unittest.TestCase):
    ...
    def test_generate_empty(self):
        x = []
        assert awkward0.fromiter(x).tolist() == x
    ...
    def test_generate_primitive(self):
        ...
        x = [1, 2, 3]
        assert isinstance(awkward0.fromiter(x).tolist()[0], int)
        x.insert(1, None)
        assert awkward0.fromiter(x).tolist() == x
        x.insert(0, None)
        assert awkward0.fromiter(x).tolist() == x
        ...
        x = [1, 2, 3.3]
        assert isinstance(awkward0.fromiter(x).tolist()[0], float)
        x.insert(1, None)
        assert awkward0.fromiter(x).tolist() == x
        x.insert(0, None)
        assert awkward0.fromiter(x).tolist() == x
    ...
    def test_generate_strings_dictencoding(self):
        x = [b"one", b"two", b"three"]
        assert awkward0.fromiter(x, dictencoding=True).tolist() == x
        x.insert(1, None)
        assert awkward0.fromiter(x, dictencoding=True).tolist() == x
        x.insert(0, None)
        assert awkward0.fromiter(x, dictencoding=True).tolist() == x
        ...
        x = [b"one", b"two", b"three"]
        assert awkward0.fromiter(x, dictencoding=lambda x: True).tolist() == x
        x.insert(1, None)
        assert awkward0.fromiter(x, dictencoding=lambda x: True).tolist() == x
        x.insert(0, None)
        assert awkward0.fromiter(x, dictencoding=lambda x: True).tolist() == x
    ...
    def test_generate_jagged(self):
        ...
        x = [[999], [], [999]]
        assert isinstance(awkward0.fromiter(x).tolist()[0][0], int)
        x.insert(1, None)
        assert awkward0.fromiter(x).tolist() == x
        x.insert(0, None)
        assert awkward0.fromiter(x).tolist() == x
        ...
        x = [[999], [], [3.14]]
        assert isinstance(awkward0.fromiter(x).tolist()[0][0], float)
        x.insert(1, None)
        assert awkward0.fromiter(x).tolist() == x
        x.insert(0, None)
        assert awkward0.fromiter(x).tolist() == x
    ...
    def test_generate_multijagged(self):
        ...
        x = [[[999]], [], [[999]]]
        assert isinstance(awkward0.fromiter(x).tolist()[0][0][0], int)
        x.insert(1, None)
        assert awkward0.fromiter(x).tolist() == x
        x.insert(0, None)
        assert awkward0.fromiter(x).tolist() == x
        ...
        x = [[[999]], [], [[3.14]]]
        assert isinstance(awkward0.fromiter(x).tolist()[0][0][0], float)
        x.insert(1, None)
        assert awkward0.fromiter(x).tolist() == x
        x.insert(0, None)
        assert awkward0.fromiter(x).tolist() == x
    ...
    def test_generate_table(self):
        ...
        x = [{"a": 1, "b": 1.1}, {"a": 2, "b": 2.2}, {"a": 3, "b": 3.3}]
        assert isinstance(awkward0.fromiter(x).tolist()[0]["a"], int)
        x.insert(1, None)
        assert awkward0.fromiter(x).tolist() == x
        x.insert(0, None)
        assert awkward0.fromiter(x).tolist() == x
        ...
        assert isinstance(awkward0.fromiter(x).tolist()[0]["a"], float)
        x.insert(1, None)
        assert awkward0.fromiter(x).tolist() == x
        x.insert(0, None)
        assert awkward0.fromiter(x).tolist() == x
        ...
        assert awkward0.fromiter([{}]).tolist() == [None]
        assert awkward0.fromiter([{}, {}, {}]).tolist() == [None, None, None]
        assert awkward0.fromiter([{"a": 1, "b": 1.1}, {"a": 2, "b": 2.2}, {}]).tolist() == [{"a": 1, "b": 1.1}, {"a": 2, "b": 2.2}, None]
        assert awkward0.fromiter([None, {"a": 1, "b": 1.1}, {"a": 2, "b": 2.2}, {}]).tolist() == [None, {"a": 1, "b": 1.1}, {"a": 2, "b": 2.2}, None]
        assert awkward0.fromiter([{"a": 1, "b": 1.1}, None, {"a": 2, "b": 2.2}, {}]).tolist() == [{"a": 1, "b": 1.1}, None, {"a": 2, "b": 2.2}, None]
        assert awkward0.fromiter([{"a": 1, "b": 1.1}, {}, {"a": 2, "b": 2.2}]).tolist() == [{"a": 1, "b": 1.1}, None, {"a": 2, "b": 2.2}]
        assert awkward0.fromiter([{}, {"a": 1, "b": 1.1}, {"a": 2, "b": 2.2}]).tolist() == [None, {"a": 1, "b": 1.1}, {"a": 2, "b": 2.2}]
    ...
    def test_generate_objects(self):
        ...
        assert awkward0.fromiter([S0()]).tolist() == [S0()]
        assert awkward0.fromiter([S0(), S0(), S0()]).tolist() == [S0(), S0(), S0()]
        assert awkward0.fromiter([None, S0(), S0(), S0()]).tolist() == [None, S0(), S0(), S0()]
        assert awkward0.fromiter([S0(), None, S0(), S0()]).tolist() == [S0(), None, S0(), S0()]
        assert awkward0.fromiter([None, S0(), None, S0(), S0()]).tolist() == [None, S0(), None, S0(), S0()]
    ...
    def test_generate_namedtuples(self):
        ...
        assert awkward0.fromiter([T0()]).tolist() == [T0()]
        assert awkward0.fromiter([T0(), T0(), T0()]).tolist() == [T0(), T0(), T0()]
        assert awkward0.fromiter([None, T0(), T0(), T0()]).tolist() == [None, T0(), T0(), T0()]
        assert awkward0.fromiter([T0(), None, T0(), T0()]).tolist() == [T0(), None, T0(), T0()]
        assert awkward0.fromiter([None, T0(), None, T0(), T0()]).tolist() == [None, T0(), None, T0(), T0()]
    ...
    def test_generate_jagged_jagged(self):
        ...
        x = [[[[[1]]]], [[[[2]]]]]
        assert isinstance(awkward0.fromiter(x).tolist()[0][0][0][0][0], int)

        x = [[[[[1]]]], [[[[2.2]]]]]
        assert isinstance(awkward0.fromiter(x).tolist()[0][0][0][0][0], float)
