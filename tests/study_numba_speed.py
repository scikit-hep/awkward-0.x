...
for i in range(5):
    starttime = time.time()
    mass1 = run_numpy(num_muons, pt_muons, eta_muons, phi_muons, num_jets, pt_jets, eta_jets, phi_jets)
...
starttime = time.time()
mass2 = run_python(num_muons, pt_muons, eta_muons, phi_muons, num_jets, pt_jets, eta_jets, phi_jets)
